      ...
      <div
        ...
        <div v-if="state.toolboxheader"
          ...
          <div
            ...
            v-t-plugin:pre="'editing.toolbox.title'">{{ state.title }}
          </div>
        ...
        <bar-loader :loading="state.loading || state.changingtools"/>

        <div class="panel-body" v-show="!state.changingtools">
          <!-- row 1 content-->
          <div class="tools-content row1">
            <tool
          ...
          <!-- row 4 content-->
          <div class="tools-content row4">
            <tool
              v-for="toolstate in toolsrow4" :key="toolstate.id"
              :state="toolstate"
              :resourcesurl="resourcesurl"
              @stopactivetool="stopActiveTool"
              @setactivetool="setActiveTool"/>
          ...
          <div class="message" style="margin-top: 5px;" :id="'id_toolbox_messages_'+ state.id">
            ...
            <transition name="fade">
              <toolsoftool v-if="showtoolsoftool" :tools="state.toolsoftool"/>
            </transition>
