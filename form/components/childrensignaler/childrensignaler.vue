...
<!--                        <button class="btn btn-danger" style="margin-right: 5px; color: #FFFFFF" :class="g3wtemplate.font['trash']" @click.stop.prevent="deleteChildFeature({url: childsignaler.url, id:child.id})"></button>-->
                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async deleteChildFeature({url, id}={}){
                await EditingService.deleteChildFeature({url, id});
